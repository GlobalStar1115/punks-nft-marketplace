...
const FundWallet = () => {
  ...
  return (
    <div className="">
      ...
      <input
        className="bg-transparent  mt-3 py-1 px-2 focus:ring-0 outline-0  text-2xl outline-none border-none"
        value={value}
        onChange={(e) => setValue(e.target.value)}
      />
      <button
        className="inset-x-0 md:bottom-20   h-16 w-[200px] left-0 right-0 md:mx-auto  text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 
